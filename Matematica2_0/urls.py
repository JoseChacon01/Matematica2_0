"""Matematica2_0 URL Configuration
...
from core.views import home, perfil, autenticacao, desconectar, cadastro_manual, registro, noticias, detalhe_noticia, pesquisadores, perfil
